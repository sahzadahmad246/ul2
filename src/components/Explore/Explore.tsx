...
export function Explore() {
  ...
  }, [allPoems.length, poets.length, query, randomPoems.length, randomPoets.length, fetchPoems, fetchAllPoets, fetchRandomPoems, fetchRandomPoets])
  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-3 sm:py-4">
                          ...
                          <CardContent className="p-3">
                            ...
                            <div className="flex items-center justify-between mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-border/30">
                              ...
                              <div className="flex items-center gap-2 sm:gap-3 text-xs text-muted-foreground">
                                ...
                                <span className="flex items-center gap-1">
                                  <Bookmark className="h-3 w- pasando-3" />
                                  <span className="hidden sm:inline">{poem.bookmarkCount || 0}</span>
                                </span>
                              </div>
                            </div>
